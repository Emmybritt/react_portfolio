			...
			<div className="row">
				...
				<div className="col-lg-4 my-3" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100">
					...
					<ul className="aducation-box dark-bg">
						<li>
							<span className="theme-bg">2018</span>
				...
				<div className="col-lg-4 ml-auto my-3" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
					<div className="sm-title">
					...
					<div className="gray-bg skill-box">
						...
						<div className="skill-lt">
							...
							<div className="skill-bar">
								<div className="skill-bar-in theme-bg" style={{ width: 86 + "%" }}>
									<span>86%</span>
								</div>
							</div>
						</div>
