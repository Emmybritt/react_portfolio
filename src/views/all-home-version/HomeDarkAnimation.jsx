					...
					<div className="row justify-content-center section-title text-center">
						<div className="col-lg-7">
							...
							<p>
								...
								stylish, modern websites, web services, mobile apps and online stores.
							</p>
						</div>
					</div>
					{/* End .row */}
					...
					<div className="row align-items-center">
						...
						<div className="col-lg-4 ml-auto my-3">
							<div className="contact-info">
								<div className="sm-title" data-aos="fade-up" data-aos-duration="1200">
									<h4 className="font-alt">Get in touch</h4>
									<p>
										Always available for freelancing if the right project comes along,
										Feel free to contact me. Am also in for full time onsite job.
									</p>
								</div>
